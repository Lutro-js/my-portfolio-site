...
export const worksData = [
...

  {
    ...
    mockupImages: [
      { src: Insta_feed1, alt: 'Instagram用キャンペーン画像' },
    ],
    nextWork: {
...

  {
    ...
    isVerticalMockup: true,
    mockupImages: [
      { src: Insta_feed2, alt: 'Instagram用フィード広告バナー' },
    ],
    nextWork: {
      title: "Instagram用フィード広告バナー",
...

  {
    ...
    isVerticalMockup: true,
    mockupImages: [
      { src: Insta_feed3, alt: 'Instagram用フィード広告バナー' },
    ],
    nextWork: {
      title: "Instagram用フィード広告バナー",
      slug: "instagram-feed-banner3",
...

  {
    ...
    category: "GRAPHIC",
    description: "9月特典のお知らせバナーを作成しました",
    target: [
      "デザインスクールを検討している人",
    ],
    problem: "",
    purpose: "",
    structure: "",
    process: ["晴れた青空にイチョウの木が伸びている画像を使用し初秋の雰囲気を出しました"],
    duration: "5日",
    tools: ["Figma"],
    highlights: [
      "Amazonギフト券がもらえることがすぐに分かるよう、画像や配置を工夫しました",
    ],
    isVerticalMockup: true,
    mockupImages: [
...

  {
    ...
    isVerticalMockup: true,
    mockupImages: [
      { src: UIUXCose_banner, alt: 'UIUXコースリスキリングバナー' },
    ],
    nextWork: {
      title: "リスキリング説明会バナー",
...

  {
    ...
    isVerticalMockup: true,
    mockupImages: [
      { src: ad_reskilling_banner, alt: 'リスキリング説明会バナー' },
    ],
    nextWork: {
