...
export const worksData = [

  {
    ...
    // （必要なら軽量版PDFのダウンロードリンクも）
    pdfUrl: "/files/ui_improvement.pdf",
  ...
  // Miro埋め込みのサンプル作品
  {
    ...
    category: "UI",
    description: "既存アプリのUI改善テーマで、アップデート後の売上とロイヤルユーザーKPIを基準に、3つの改善を行いました",
    purpose: "",
    duration: "３週間",
